...
public class ItemStackTool {
    ...
    public static ItemStack item(Material mat, int amount, short damage, byte data) {
    ...
    public static ItemStack item(Material mat, int amount, short damage, byte data, String displayName,
	    String... lore) {
	ItemStack item = new ItemStack(mat, amount, damage, data);
